...
labels, q = CP2K_methods.read_trajectory_xyz_file("Ethylene_MD-pos-1.xyz", 0)
print(labels)
print(q)
...
# Lowest and highest orbital, Here HOMO is 6
params['lowest_orbital'] = 1
params['highest_orbital'] = 20
...
# Do the first 400 steps 
for i in range(400):
    #print(F"======== Iteration {i} ==============")
    labels, q = CP2K_methods.read_trajectory_xyz_file("Ethylene_MD-pos-1.xyz", i)
    params["timestep"] = i
