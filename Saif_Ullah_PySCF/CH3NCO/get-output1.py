...
def parse_pyscf_tddft(log_filename):
    ...
    # CHANGED: Match the Methylisocyanate header printed by your input loop
    basis_sections = re.split(r"METHYLISOCYANATE - Basis: ", content)
